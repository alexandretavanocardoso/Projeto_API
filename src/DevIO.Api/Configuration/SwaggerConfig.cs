...
namespace DevIO.Api.Configuration
{
    public static class SwaggerConfig
    {
        ...
        {
            //app.UseMiddleware<SwaggerAuthorizedMiddleware>(); // Verifica o acesso
            app.UseSwagger();
            app.UseSwaggerUI(
                options =>
                {
    ...
    {
        readonly IApiVersionDescriptionProvider provider; // Interface de versionamento
    ...
    public class SwaggerAuthorizedMiddleware
    {
        ...
        {
            if (context.Request.Path.StartsWithSegments("/swagger") // Verifica se no Path existe swagger
